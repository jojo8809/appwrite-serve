...
module.exports = async function(req, res) {
  try {
    ...
    // Always ensure to is an array, regardless of what was passed in
    const recipients = Array.isArray(to) ? [...to] : [to];
    
    // Ensure business email is included - do this check using lowercase
    const businessEmail = 'info@justlegalsolutions.org';
    const hasBusinessEmail = recipients.some(email => 
      email.toLowerCase() === businessEmail.toLowerCase()
    );
